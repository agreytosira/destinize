                    ...
                    <div className='flex flex-col gap-8 mt-10'>
                        <div className='flex items-center gap-4'>
                            ...
                            <div>
                                ...
                                <p className='w-2/3'>Temukan destinasi selanjutnya yang akan kamu kunjungi dengan Destinize</p>
                            </div>
                        </div>
                        <div className='flex items-center gap-4'>
                            <div className='size-14'>
                            ...
                            <div>
                                ...
                                <p className='w-2/3'>Tulis dan lengkapi data kamu untuk keperluan data booking</p>
                            </div>
                        </div>
                        <div className='flex items-center gap-4'>
                            <div className='size-14'>
                            ...
                            <div>
                                ...
                                <p className='w-2/3'>Kamu bisa langsung masuk dan enjoy liburan kamu tanpa hambatan</p>
                            </div>
                        </div>
                    </div>
                </div>
                <img className='w-full' src='/reservation-guide.svg' alt='Reservation Guide Illustration' />
            </div>
        </div>
    );
}
