function FindTour() {
  return (
    <div className='container my-16'>
      ...
      <div className='grid grid-cols-2 gap-6 sm:grid-cols-3 mt-14 '>
        <div className='flex items-start gap-4'>
          <img src='/find1.png' alt='Find Tour Icon 1' />
          <div className='flex flex-col items-start'>
            <h6 className='font-extrabold'>Populer Di dekatmu</h6>
            <p className='mt-2 font-medium'>Tempat pariwisata yang populer dan pasti dikenal semua orang didekatmu</p>
          </div>
        </div>
        <div className='flex items-start gap-4'>
          ...
          <div className='flex flex-col items-start'>
            ...
            <p className='mt-2 font-medium'>Tempat favorit dan disukai semua orang orang di sekitar daerah kamu</p>
          </div>
        </div>
        <div className='flex items-start gap-4'>
          ...
          <div className='flex flex-col items-start'>
            ...
            <p className='mt-2 font-medium'>Spot yang paling ramai dikunjungi para warga sekaligus para wisatawan</p>
          </div>
        </div>
      </div>
    </div>
