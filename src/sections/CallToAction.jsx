...
function CallToAction() {
  return (
    <div className='container my-32'>
      <div className='items-center gap-4 overflow-hidden bg-blue-600 rounded-lg lg:grid lg:grid-cols-2'>
        ...
        <div className='flex justify-end h-full'>
          <img src='/cta.png' alt='CTA Illustration' className='hidden h-full lg:flex' />
        </div>
      </div>
    </div>
  )
